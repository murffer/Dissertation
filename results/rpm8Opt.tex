...
\begin{figure}
	\centering
	\includegraphics[widhth=\textwidht]{{20Length2.5cpsMinFluxProfiles}.eps}
...
Thus it is demonstrated that a large reflector is desired.10Length2.5cpsMinFluxProfiles.eps
