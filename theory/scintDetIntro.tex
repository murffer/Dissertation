...
\begin{figure}
  ...
  \caption[Light yield non-proportionality of anthracene]{Light yield non-proportionalityof anthracene. Data from \cite{Verbinski_1968}.}
...
\begin{figure}
  ...
  \caption[GEANT4 simulated light output of alpha, tritons and electrons in polystyrene]{Simulated optical photons distributions for the particles of interest in a portal monitor. The light yield was assumed to be 1,000 photons per MeV.}
