...
\label{tab:PhysicalProperties}
  ...
  \toprule
    ...
    Annealed PEN & \iso[6]{Li} & $\approx$ \SI{212}{\um} & 42.42 \\
...
\begin{table}
  ...
  \label{tab:AvgChNG}
  \small
  %\begin{tabular}{p{4cm}| m{2cm} m{2cm} | m{2cm} m{2cm}}
  \begin{tabular}{c | c c | c c}
    \toprule
        &\multicolumn{2}{c}{Gamma}&\multicolumn{2}{|c}{Neutron}\\
        & Average & Photons & Average & Photons \\
        & Channel& per MeVee & Channel & per Neutron\\
    \midrule
    ...
    GS20 &	172.76	&	3,800	&	524.10	&	6,250	\\
    Annealed PEN & 41.11 & 1,800 & 142.01 & 1,700\\
...
\centering
  ...
  \label{tab:CountRate}
  \small
  \begin{tabular}{p{4cm}| m{2cm} m{2cm} |m{2cm} m{2.2cm}}
  \toprule
  ...
  {Annealed PEN}&	322	& 227	&	5.35 &	7.60	\\
...
\begin{table}
  ...
  \begin{tabular}{m{5cm} | m{3cm} m{5cm}}
    ...
    {Annealed PEN,\SI{212}{\um}, 25\% LiF}	&	284	&	0.73	\\
