...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\graphicspath{{tmp/}{figures/}{figures/eps/}{figures/pdf/}{code/GARP8MOpt/} }% specify the path where figures are located
\usepackage{fancyhdr}                   % fancy headers and footers
\usepackage[inactive]{srcltx}		 	% necessary to use forward and inverse searching in DVI
\usepackage{relsize}                    % font sizing hierarchy
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{SimDescriptions}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
    ...
    %
    \addToPDFBookmarks{1}{Executive Summary}{e} % add a pdf bookmark to the title page
    \input{front-matter/ExecutiveSummary}
    %
    \addToPDFBookmarks{1}{Table of Contents}{f}
    \tableofcontents % generate a table of contents
    %
    \addToPDFBookmarks{1}{List of Tables}{g}
    \listoftables % generate a list of tables
    %
    \addToPDFBookmarks{1}{List of Figures}{h}
    \listoffigures % generate a list of figures
    %
    \makenomenclature % OPTIONAL
    \addToPDFBookmarks{1}{Nomenclature}{i} % OPTIONAL
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \include{chapters/intro}  		% Problem introduction
    \include{chapters/theory}  		% Phyics Theory
    \include{chapters/methods}		% Modeling and GA Intro
    \include{chapters/results}		% Optimization Results
    ...
    \appendix
    \include{back-matter/ComptonScattering}
    \include{back-matter/MCNPXReactionRateCalc}
    \include{back-matter/G4Intro}
    \include{back-matter/DetectorCharacterization}
    \include{back-matter/DetectorComparisons}
    \include{back-matter/code}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % A VITA IS REQUIRED
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \addToTOC{Vita}
