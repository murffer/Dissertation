...
% \autoref{tab:EXSumPerf} is based on a \SI{100}{\um}, 10\% \iso[6]{LiF} loaded film while the \SI{50}{\um}, 10\% \iso[6]{LiF} loaded polystyrene film has a higher light output.
% The polystyrene light output could then be improved by using two \SI{50}{\um} films sandwhiched together.
\begin{table}
