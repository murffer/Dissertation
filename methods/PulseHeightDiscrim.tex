...
The fraction of the neutron counts above a given discriminator setting necessary to achieve a given gamma intrinsic efficiency is plotted in \autoref{fig:crVsIntEff}.
...
\begin{figure}[ht]
    ...
    \caption{Intrinsic efficiency versus neutron count rate for polystyrene loaded with 10\% \iso[6]{LiF}.}
