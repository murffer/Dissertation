...
Thus, as shown in \autoref{fig:SimLightQuench} the triton from the \iso[6]{Li} reaction will produce about an factor of four more photons than an \SI{100}{\keV}, and dominates the number of photons produced the the alpha particle.
\begin{figure}
  \centering
  \includegraphics[width=\textwidth]{Verbinski_LightYield_AlpahCarbonProton}
