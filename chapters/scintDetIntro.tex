...
\autoref{fig:lightYieldVerbinski} summerizes the results of \cite{Verbinski_1968} in which the pulse height deficit is apparent for the as the charged ions become heavier.
\begin{figure}
  \centering
...
GEANT4 has the capability to simulate light quenching by setting an appropriate Birks parameter, and \autoref{fig:SimLightOutputQuench} presents GEANT4 simualated photon distrubtions in polystyrene with a PPO-POPOP fluor and an assumed light yeild of 1,000 photons per MeV.
...
However, it is unlikely that many electrons orginating from \iso[60]{Co} interactions in the scintillator will have an energy in the \SI{1}{\MeV} range, more likely that they will be in the \SI{100}{\keV} range.
...
These results are summerized in \autoref{tab:PulseHeightDeficitSim}.
\begin{table}
