...
The basis for setting a pulse height discrimiantor to differniate between neutorn and gammas can be attributed to the secondary electrons and the differnece in energy mechanicms as presented in the first section of thi chapter.
