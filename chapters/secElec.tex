...
\autoref{sec:InteractionsAndRange} will describe the physics of charged particle and gamma interactions in plastics (focusing on polystyrene) in order to explain the basis for the difference in energy depositions. 
