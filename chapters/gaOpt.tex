...
%%%
A fast simulation model (XSDRN) will be used to preform an initial parameter study and determine a subset of optimal geometeries on which to preform more accurate monte carlo (MCNPX) modeling. 
The a subset of the highest preforming geoemtries validated by the detailed model with then be used to test the sensitivity by adjusting the position of the films by fractional amounts.
%%%
